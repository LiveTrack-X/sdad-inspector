...
| CLAIM-SI-007 | Windows, macOS, and Ubuntu preview jobs are configured | allowed_with_qualifier | P2_qualified | Developer docs | EVID-SI-004 | `workflow configuration only; macOS/Linux results unobserved` | Product support headline | Configuration is not runtime evidence |
