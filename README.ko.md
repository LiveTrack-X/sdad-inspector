...
> **0.0.2 is a regular GitHub Release, but remains unsigned.** 설치 프로그램이
...
1. [`v0.0.2` 릴리스](https://github.com/LiveTrack-X/sdad-inspector/releases/tag/v0.0.2)를 엽니다.
...
`0.0.2` 포터블 앱에는 검증된 `official-sdad-3` 어댑터와 SDAD 3.2.2 엔진만
...
- [`docs/releases/v0.0.2.md`](docs/releases/v0.0.2.md) — 현재 릴리스
...
정확한 `v0.0.2` 태그는 같은 검증을 다시 수행한 뒤 세 플랫폼 압축과
